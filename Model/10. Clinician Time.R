...
calculate_no_appts <- function(complete_pop_yr_fu,
  ...
  post_op_imaging <- ifelse(imaging_fu_type == "ct",
                            1,
                            2) # Presume that if having non CT imaging, then need an XR to determine lucency
      ...
      xr_only_fu_sf <- complete_pop_yr_fu1 %>%
        ...
        mutate(
          ...
          appt_year_1 = case_when(
            ...
            # Recurrence
            death_year_1 == "No" &
              colic_intervention_type_year_1 == "Colic" ~ rec_appts_colic,
            death_year_1 == "No" &
              colic_intervention_type_year_1 == "ESWL" ~ rec_appts_eswl,
            death_year_1 == "No" &
              colic_intervention_type_year_1 == "URS" ~ rec_appts_urs,
            death_year_1 == "No" &
              colic_intervention_type_year_1 == "PCNL" ~ rec_appts_pcnl,
            TRUE ~ NA_real_
          ),
          ...
          appt_year_2 = case_when(
            ...
            death_year_2 == "No" &
              ...
              recurrence_year_1 == "No" ~ rec_appts_colic,
            death_year_2 == "No" &
              colic_intervention_type_year_2 == "ESWL" &
              recurrence_year_1 == "No" ~ rec_appts_eswl,
            death_year_2 == "No" &
              colic_intervention_type_year_2 == "URS" &
              recurrence_year_1 == "No"  ~ rec_appts_urs,
            death_year_2 == "No" &
              colic_intervention_type_year_2 == "PCNL" &
              recurrence_year_1 == "No" ~ rec_appts_pcnl,
          ...
          appt_year_3 = case_when(
            ...
            death_year_3 == "No" &
              ...
              recurrence_year_2 == "No" ~ rec_appts_colic,
            death_year_3 == "No" &
              colic_intervention_type_year_3 == "ESWL" &
              recurrence_year_2 == "No" ~ rec_appts_eswl,
            death_year_3 == "No" &
              colic_intervention_type_year_3 == "URS" &
              recurrence_year_2 == "No"  ~ rec_appts_urs,
            death_year_3 == "No" &
              colic_intervention_type_year_3 == "PCNL" &
              recurrence_year_2 == "No" ~ rec_appts_pcnl,
          ...
          appt_year_4 = case_when(
            ...
            death_year_4 == "No" &
              ...
              recurrence_year_3 == "No" ~ rec_appts_colic,
            death_year_4 == "No" &
              colic_intervention_type_year_4 == "ESWL" &
              recurrence_year_3 == "No" ~ rec_appts_eswl,
            death_year_4 == "No" &
              colic_intervention_type_year_4 == "URS" &
              recurrence_year_3 == "No"  ~ rec_appts_urs,
            death_year_4 == "No" &
              colic_intervention_type_year_4 == "PCNL" &
              recurrence_year_3 == "No" ~ rec_appts_pcnl,
          ...
          appt_year_5 = case_when(
            ...
            death_year_5 == "No" & recurrence_year_5 == "Yes" &
              ...
              recurrence_year_3 == "Yes" &
              recurrence_year_2 == "Yes" &
              recurrence_year_1 == "Yes" & risk_status == "LR" ~ 0,
            death_year_5 == "No" & recurrence_year_5 == "Yes" &
              recurrence_year_4 == "Yes" &
              recurrence_year_3 == "Yes" &
              recurrence_year_2 == "Yes" &
...
summary_df <- data_for_plot %>%
  ...
  summarise(total_appts = sum(annual_appts, na.rm = TRUE),
            .groups = "drop")
...
summary_df_appts <- summary_df_appts %>% mutate(total_appts = total_appts / 1000)
...
summary_df_appts %>% group_by(auc_label) %>% ggplot(aes(x = auc_label, y = total_appts, fill = risk_status)) +
  ...
  labs(title = "Annual Number of Appointments for EAU Follow-Up of those with Clinically Significant Disease",
       x = "Cohort Type",
...
summary_df_appts %>%
  ...
  group_by(auc_label, cohort_type) %>%
  summarise(total_appts = sum(round(total_appts, 0))) %>%
  gt()
