...
calculate_economic_costs <- function(complete_pop_yr_fu,
  ...
  year_1_lr_sf_fu_cost <- fu_costs_1$cost[1] %>% as.integer()
  year_2_lr_sf_fu_cost <- fu_costs_1$cost[2] %>% as.integer()
  year_3_lr_sf_fu_cost <- fu_costs_1$cost[3] %>% as.integer()
  year_4_lr_sf_fu_cost <- fu_costs_1$cost[4] %>% as.integer()
  year_5_lr_sf_fu_cost  <- fu_costs_1$cost[5] %>% as.integer()
  year_1_lr_less4_fu_cost <- fu_costs_1$cost[6] %>% as.integer()
  year_2_lr_less4_fu_cost <- fu_costs_1$cost[7] %>% as.integer()
  year_3_lr_less4_fu_cost <- fu_costs_1$cost[8] %>% as.integer()
  year_4_lr_less4_fu_cost <- fu_costs_1$cost[9] %>% as.integer()
  year_5_lr_less4_fu_cost <- fu_costs_1$cost[10] %>% as.integer()
  year_1_lr_more4_fu_cost <- fu_costs_1$cost[11] %>% as.integer()
  year_2_lr_more4_fu_cost <- fu_costs_1$cost[12] %>% as.integer()
  year_3_lr_more4_fu_cost <- fu_costs_1$cost[13] %>% as.integer()
  year_4_lr_more4_fu_cost <- fu_costs_1$cost[14] %>% as.integer()
  year_5_lr_more4_fu_cost <- fu_costs_1$cost[15] %>% as.integer()
  year_1_hr_sf_fu_cost_current <- fu_costs_1$cost[16] %>% as.integer()
  year_1_hr_sf_fu_cost_eau <- fu_costs_1$cost[17] %>% as.integer()
  year_2_hr_sf_fu_cost_current <- fu_costs_1$cost[18] %>% as.integer()
  year_2_hr_sf_fu_cost_eau <- fu_costs_1$cost[19] %>% as.integer()
  year_3_onwards_hr_sf_fu_cost_current <- fu_costs_1$cost[20] %>% as.integer()
  year_3_onwards_hr_sf_fu_cost_eau <- fu_costs_1$cost[21] %>% as.integer()
  year_3_hr_sf_fu_cost_current <- fu_costs_1$cost[22] %>% as.integer()
  year_3_hr_sf_fu_cost_eau <- fu_costs_1$cost[23] %>% as.integer()
  year_4_hr_sf_fu_cost_eau <- fu_costs_1$cost[24] %>% as.integer()
  year_5_hr_sf_fu_cost_eau <- fu_costs_1$cost[25] %>% as.integer()
  year_1_hr_less4_fu_cost_eau <- fu_costs_1$cost[26] %>% as.integer()
  year_2_hr_less4_fu_cost_eau <- fu_costs_1$cost[27] %>% as.integer()
  year_3_hr_less4_fu_cost_eau <- fu_costs_1$cost[28] %>% as.integer()
  year_4_hr_less4_fu_cost_eau <- fu_costs_1$cost[29] %>% as.integer()
  year_5_hr_less4_fu_cost_eau <- fu_costs_1$cost[30] %>% as.integer()
  year_1_hr_more4_fu_cost_eau <- fu_costs_1$cost[31] %>% as.integer()
  year_2_hr_more4_fu_cost_eau <- fu_costs_1$cost[32] %>% as.integer()
  year_3_hr_more4_fu_cost_eau <- fu_costs_1$cost[33] %>% as.integer()
  year_4_hr_more4_fu_cost_eau <- fu_costs_1$cost[34] %>% as.integer()
  year_5_hr_more4_fu_cost_eau <- fu_costs_1$cost[35] %>% as.integer()
