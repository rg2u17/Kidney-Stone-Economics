...
# 1. Define Inputs
```{r}
source("~/Kidney-Stone-Economics/Model/1. Define Inputs.R")
```
\newpage

# 2. Total Cost Calculation for Stone Free Patients
```{r}
source("~/Kidney-Stone-Economics/Model/2. Total Cost Calculation for Stone Free Patients.R")
```
\newpage

# 3. Visualise Model 
```{r}
source("~/Kidney-Stone-Economics/Model/3. Visualise Model.R")
```
\newpage
...
```{r}
source("~/Kidney-Stone-Economics/Model/4. Model - Beta Distribution for Scores.R")
```
\newpage
...
```{r}
#source("~/Kidney-Stone-Economics/Model/4. Model - Normal Distribution for Scores.R")
```
\newpage

# 5. Run Model
```{r}
source("~/Kidney-Stone-Economics/Model/5. Run Model.R")
```
\newpage
...
# 6. Radiation Dose
```{r}
source("~/Kidney-Stone-Economics/Model/6. Radiation Dose.R")
```
\newpage
...
```{r}
source("~/Kidney-Stone-Economics/Model/7. Radiation Induced Malignancy.R")
```
\newpage
...
```{r}
source("~/Kidney-Stone-Economics/Model/8. Economic Costs - All Patients.R")
```
\newpage
...
```{r}
source("~/Kidney-Stone-Economics/Model/9. Economic Costs - Recurrence only.R")
```
\newpage
...
```{r}
source("~/Kidney-Stone-Economics/Model/10. Clinician Time.R")
```
\newpage
...
# 11. Quality of Life
```{r}
source("~/Kidney-Stone-Economics/Model/11. Quality of Life.R")
```
\newpage
...
# 12. Calculate ICER 
```{r}
source("~/Kidney-Stone-Economics/Model/12. Calculate ICER.R")
```
\newpage
...
# 13. CO2 Emissions
```{r}
#source("~/Kidney-Stone-Economics/Model/13. Calculate CO2 emissions.R")
```
\newpage
...
# 15. QoL - EQ-5D
```{r}
source("~/Kidney-Stone-Economics/Model/11. Quality of Life - EQ-5D old v2.R", echo = TRUE)
```
\newpage
...
### Plot overall results
```{r}
summary_df_full_qol_eq_5d_plot <- summary_df_full_qol_eq_5d_plot + scale_fill_manual(values = risk_colours)
